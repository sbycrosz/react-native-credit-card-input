...
| accessibilityLabels   | PropTypes.object                        | Defaults to <br/>`{ name: "Full Name", number: "1234 5678 1234 5678", expiry: "MM/YY", cvc: "CVC", postalCode: "34567" }`<br/> Accessibily labels that will applied for each text input.                |
