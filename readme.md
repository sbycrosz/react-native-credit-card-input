...
// will print:
{
  ...
  values: { // will be in the sanitized and formatted form
  	number: "4606390200004088",
  	expiry: "04/24",
  	cvc: "427",
  	type: "visa", // will be one of [null, "visa"]
  	name: "Algin",
  	postalCode: "0021",
  },
  status: {  // will be one of ["complete", "valid", and "valid"]
	number: "4606 3902 0000 4088",
	expiry: "04/24",
	cvc: "427",
	name: "Algin", 
	postalCode: "0021",
...
|placeholders | PropTypes.object | Defaults to <br/>`{ number: "4606 3902 0000 4088", expiry: "04/24", cvc: "427" }` |
...
|onChange | PropTypes.func | Receives a `formData` object every time the form changes |
|onFocus | PropTypes.func | Receives the name of currently focused field |
|labels | PropTypes.object | Defaults to <br/>`{ number: "4606 3902 0000 4088", expiry: "04/24", cvc: "CVC/427" }` |
|placeholders | PropTypes.object | Defaults to <br/>`{ number: "4606 3902 0000 4088", expiry: "04/24", cvc: "427" }` |
...
|invalidColor | PropTypes.string | Color that will be applied for invalid text input. Defaults to: "red" |
|placeholderColor | PropTypes.string | Color that will be applied for text input placeholder. Defaults to: "gray" |
|requiresName | PropTypes.bool | Shows cardholder's name field<br/> Default to `true` |
|requiresCVC | PropTypes.bool | Shows CVC field<br/> Default to `true` |
|requiresPostalCode | PropTypes.bool | Shows postalCode field<br/> Default to `true` |
|validatePostalCode | PropTypes.func | Function to validate postalCode, expects `incomplete`, `valid`, or `valid` as return values|
|allowScroll | PropTypes.bool | enables horizontal scrolling on CreditCardInput <br/> Defaults to `true` |
...
```js
	// sets 42402 on credit card number field
	// other fields will stay unchanged
	this.refs.CCInput.setValues({ number: "42402" });
```

**Known issues:** clearing a field e.g. `setValues({ expiry: "04/24" })` will trigger the logic to `move to previous field` and trigger other kind of weird side effects. **PR plz**
...
* Android `monospace` fonts doesn't looks as nice as iOS `Courier`, bundle custom fonts into your app and override the default using `
# React Native Credit Card Input
Easy (and good looking) credit-card input for your React Native Project 💳 💳
...
e-credit-card-input
* Grain.com.sg ([iOS](https://grain.com.sg/mobile/ios/download), [Android](https://grain.com.sg/mobile/android/download)) – Gourmet food delivery in Singapore
ain.com.sg/mobile/ios/download), [Android](https://grain.com.sg/mobile/android/download)) – Gourmet food delivery in Singapore
e-credit-card-input
* Grain.com.sg ([iOS](https://grain.com.sg/mobile/ios/download), [Android](https://grain.com.sg/mobile/android/download)) – Gourmet food delivery in Singapore
